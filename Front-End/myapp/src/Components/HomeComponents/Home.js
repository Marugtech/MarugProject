        ...
        <Col className='pt-3' xs={12} md={4}>
          <div className='cards'>
            <Card border="light">
              ...
              <Popup trigger={<Button style={{ background: "#ECECEC", color: "black", border: "white", fontFamily: "Figtree", fontSize: "15px", boxShadow: "none" }} className="cards">QUICK VIEW</Button>}
        ...
        <Col className='pt-3' xs={12} md={4}>
          <div className='cards'>
            <Card border="light">
              ...
              <Popup trigger={<Button style={{ background: "#ECECEC", color: "black", border: "white", fontFamily: "Figtree", fontSize: "15px", boxShadow: "none" }} className="quickview cards">QUICK VIEW</Button>}
                position="center bottom" className='pop-position'>
                <div className='quickview-popup'>
                  <div className='popup-card cards'>
                    <Card border="light">
